...
include::https://github.com/cherepakhin/messaging-stomp-websocket/blob/main/src/main/java/com/example/messagingstompwebsocket/MessagingStompWebsocketApplication.java
